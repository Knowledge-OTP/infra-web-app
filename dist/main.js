...
(function (angular) {
    ...
    angular.module('znk.infra-web-app.tests').provider('testsRoadmapSrv', [
        function () {
            ...
            this.$get = ["$log", "$injector", "$q", "ExerciseResultSrv", "ExamSrv", "ScoringService", "ExerciseTypeEnum", "TestScoreCategoryEnum", function ($log, $injector, $q, ExerciseResultSrv, ExamSrv, ScoringService, ExerciseTypeEnum, TestScoreCategoryEnum) {
                'ngInject';
                var testsRoadmapSrv = {};
