...
(function (angular) {
    ...
    angular.module('znk.infra-web-app.estimatedScoreWidget').directive('estimatedScoreWidget',
        ["EstimatedScoreSrv", "$q", "SubjectEnum", "UserGoalsService", "EstimatedScoreWidgetSrv", "$translatePartialLoader", "$mdDialog", "$timeout", function (EstimatedScoreSrv, $q, SubjectEnum, UserGoalsService, EstimatedScoreWidgetSrv, $translatePartialLoader, $mdDialog, $timeout) {
            'ngInject';
            var previousValues;
...
angular.module('znk.infra-web-app.scoringSrv').run(['$templateCache', function($templateCache) {
